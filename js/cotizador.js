console.log("COTIZADOR JS conectado v27");
...
async function createPDF(){
  ...
  try{
    ...
    try{
      ...
      showToast(uploadError.message || "PDF no subido a Supabase", "err");
    }
    ...
    if(pdfSubido){
      ...
      showToast("Cotización guardada. PDF descargado, pero falta crear el bucket.", "err");
    }
  }catch(err){
    console.error(err);
