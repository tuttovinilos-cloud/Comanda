console.log("MENU GLOBAL conectado v10");

/* =========================================================
   MENU GLOBAL COMANDA / TUTTOVINILOS v10
   - Usa #authMenu
...
(function(){
  ...
  function renderMenu(){
    ...
    logoutBtn.className = menu.classList.contains("app-menu") ? "" : "tab-btn";
  ...
  function setupMobileMenu(){
    ...
    if(!btn){
      ...
      btn.className = menu.classList.contains("app-menu") ? "app-menu-btn" : "mobile-menu-btn";
      btn.type = "button";
  ...
  function marcarMenuListo(){
    ...
    /* FIX: el HTML arranca con class="loading-menu".
       Si no se remueve, el menú puede quedar en estado de carga
       y producir flashes/delay visual. */
